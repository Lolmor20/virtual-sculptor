...
namespace Assets.Scripts.Menus
{
    public class ToolsMenu : Menu
    {
        ...
        public MenuIcon sculptingIcon { get; set; } = new ToolsMenuIcon(GameObject.Find("Sculpting"), GameManager.Instance.ActionsData.Sculpting, MenuManager.Instance.ParametersMenusData.SculptingParametersMenu);
